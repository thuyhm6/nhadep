...
@section('content')
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <!-- edit-category -->
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{ route('admin.categoryPost.update') }}" method="POST"
                        ...
                        <div class="upload-image flex-grow">
                            @if ($category->image)
                                <div class="item" id="imgpreview">
                                    <img src="{{ asset('uploads/categoryPosts') }}/{{ $category->image }}" class="effect8"
                                        alt="">
                                </div>
                            @endif
