        ...
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.product.store') }}">
            ...
            <div class="wg-box">
                ...
                <fieldset class="description">
                    ...
                    <textarea class="ckeditor mb-10" name="description" tabindex="0" aria-required="true" required="">{{ old('description') }}</textarea> 
                </fieldset>
                @error('description')
                    <span class="alert alert-danger text-center">{{ $message }}</span>
                @enderror
    ...
    $(function() {
        ...
        $("#gFile").on("change", function(e) {
            ...
            $.each(gphotos, function (key, value) {
                $("#galUpload").prepend(`<div class="item gitems"><img src="${URL.createObjectURL(value)}" alt=""</div>`)
            })
